...
export function TabsList({ className, ...props }: any) {
  return (
    <TabsPrimitive.List
      className={cn(
        "inline-flex h-auto min-h-10 flex-wrap items-center justify-center rounded-md bg-muted p-1",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      className={cn(
        ...
        "data-[state=inactive]:bg-transparent data-[state=inactive]:text-gray-600 hover:bg-muted",
        className
      )}
      {...props}
    />
