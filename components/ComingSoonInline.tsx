...
export default function ComingSoonInline({ message, sectionName }: ComingSoonInlineProps) {
    ...
    return (
        <div className="relative w-full h-full min-h-[300px] bg-slate-950/40 backdrop-blur-xl rounded-[2rem] border border-white/5 flex flex-col items-center justify-center p-8 overflow-hidden group" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            {/* Background effects */}
