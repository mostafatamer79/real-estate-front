...
const Map = dynamic(() => import('@/app/src/components/Map'), { 
  ...
  loading: () => {
    const { t } = useLanguage();
    return <div className="h-[400px] w-full bg-slate-100 animate-pulse rounded-xl flex items-center justify-center text-gray-400">{t('map.loading')}</div>
  }
});
...
export function AddPropertyWizard({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-[100] p-4 animate-in fade-in duration-300">
      <div 
        className="bg-white rounded-3xl max-w-5xl w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden ring-1 ring-gray-200"
        dir={isRtl ? 'rtl' : 'ltr'}
      >
        ...
        <div className="p-5 border-b border-gray-100 flex justify-between items-center bg-slate-50/50">
          ...
          <Button 
            ...
            size="icon" 
            onClick={onClose} 
            className="rounded-full hover:bg-slate-100 text-gray-500 transition-colors"
          >
            <X className="w-6 h-6" />
          </Button>
        </div>
        ...
        <div className="flex-1 overflow-hidden flex flex-col md:flex-row min-h-0">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col w-full min-h-0">
                ...
                <div className="bg-white border-b border-gray-100 px-6 py-4 overflow-x-auto shrink-0 transition-all">
                        ...
                        {tabItems.map((item, idx) => (
                            <TabsTrigger 
                                ...
                                className={`
                                    ...
                                    data-[state=active]:bg-slate-50 data-[state=active]:border-blue-200 data-[state=active]:text-blue-700
                                    data-[state=inactive]:bg-white data-[state=inactive]:border-gray-100 data-[state=inactive]:text-gray-600 data-[state=inactive]:hover:bg-slate-50
                                `}
                            >
                                <span className={`
                                    flex items-center justify-center w-6 h-6 rounded-full text-xs font-bold
                                    ${activeTab === item.id ? 'bg-slate-600 text-white shadow-md shadow-blue-600/20' : 'bg-slate-200 text-gray-600'}
                                `}>
                                    {idx + 1}
                                </span>
                                {item.label}
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8 bg-slate-50/30 w-full relative">
                                     ...
                                     <Card className="bg-white border-gray-200 shadow-sm md:col-span-2">
                                        <CardContent className="p-6 space-y-6">
                                            <div className="flex items-center gap-3 mb-2">
                                                <div className="p-2 rounded-lg bg-slate-50 text-blue-600"><Building className="w-5 h-5" /></div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div className="space-y-2">
                                                    ...
                                                    <Input 
                                                        ...
                                                        className="bg-white border-gray-300 focus:border-blue-500 h-12 transition-all font-medium text-gray-900 placeholder:text-gray-400"
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <Select value={propertyData.type} onValueChange={(v: any) => setPropertyData({...propertyData, type: v})}>
                                                        <SelectTrigger className="bg-white border-gray-300 h-12 font-medium text-gray-900"><SelectValue /></SelectTrigger>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="relative">
                                                        <Input 
                                                            ...
                                                            className="bg-white border-gray-300 focus:border-blue-500 h-12 ps-10 font-medium text-gray-900 placeholder:text-gray-400"
                                                        />
                                            ...
                                            <CardContent className="p-5 flex flex-col md:flex-row gap-4 items-end">
                                                <div className="w-full md:w-32 space-y-2">
                                                    ...
                                                    <Input 
                                                        ...
                                                        className="bg-white border-blue-200 h-11 text-gray-900"
                                                    />
                                                </div>
                                                <div className="w-full md:w-40 space-y-2">
                                                    ...
                                                    <select 
                                                        ...
                                                        className="w-full bg-white border border-blue-200 h-11 text-gray-900 rounded-lg px-3 text-sm outline-none focus:ring-2 focus:ring-blue-500/20"
                                                    >
                                         ...
                                         <div className="space-y-3">
                                            {propertyData.units?.map((unit, idx) => (
                                                <motion.div 
                                                    ...
                                                    key={idx} 
                                                    className="bg-white p-4 rounded-2xl border border-gray-200 flex items-center justify-between shadow-sm hover:shadow-md transition-shadow"
                                                >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        {editingUnitIndex !== null ? (
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                                        <div className="space-y-2">
                                                            ...
                                                            <Input 
                                                                ...
                                                                className="bg-slate-50 border-gray-200 h-11 focus:bg-white transition-colors text-gray-900" 
                                                            />
                                                        </div>
                                                        <div className="space-y-2">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <Select value={tempLease.paymentFrequency} onValueChange={(v:any) => setTempLease({...tempLease, paymentFrequency: v})}>
                                                                <SelectTrigger className="bg-slate-50 border-gray-200 h-11 text-gray-900"><SelectValue /></SelectTrigger>
                                                                <SelectContent>
                                            ...
                                            <div className="h-full flex flex-col items-center justify-center bg-white rounded-3xl border border-dashed border-gray-300 text-gray-400 p-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <Card className="bg-white border-gray-200 shadow-sm">
                                        <CardContent className="p-6">
                                            ...
                                            <div className="flex items-center justify-center p-8 bg-slate-50 rounded-2xl border border-dashed border-gray-200">
                ...
                <div className="p-6 bg-white border-t border-gray-100 flex justify-between items-center z-10">
                    <Button 
                        variant="outline" 
                        onClick={onClose}
                        className="h-12 px-8 rounded-xl border-gray-200 text-gray-700 hover:bg-slate-50 font-bold"
                    >
                        {t('common.close')}
                    </Button>
                    ...
                    <div className="flex gap-3">
                         {activeTab !== 'assets' && (
                             <Button 
                                ...
                                className="h-12 px-6 rounded-xl border-gray-200 text-gray-700 hover:bg-slate-50 font-bold"
                             >
