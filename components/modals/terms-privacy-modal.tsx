        ...
        <div className={`bg-slate-900 px-6 pt-6 ${hideTabs ? 'pb-6' : 'pb-0'} flex flex-col items-center relative overflow-hidden shrink-0`}>
          ...
          <div className={`flex items-center gap-3 relative z-10 ${hideTabs ? '' : 'mb-6'}`}>
            ...
            <div>
              ...
              <DialogDescription className="text-xs font-bold text-slate-400 mt-1">منصة دير عقارك</DialogDescription>
            </div>
          </div>
          ...
          <AnimatePresence mode="wait">
            {activeTab === "terms" && (
              ...
              >
                <div className="text-center mb-8">
                  <h1 className="text-2xl font-black text-slate-900 mb-2">شروط استخدام منصة دير عقارك</h1>
            ...
            {activeTab === "privacy" && (
              ...
              >
                ...
                <Paragraph>
                  حرصاً من منصة دير عقارك على بيانات المستخدمين ومعلوماتهم فإنها تلتزم بالمحافظة على سرية وخصوصية هذه البيانات واستخدامها للوصول إلى المستوى المأمول في تقديم الخدمة اللازمة، وذلك بما يتوافق مع الأنظمة واللوائح المعمول بها في المملكة العربية السعودية، ويعد استخدام منصة دير عقارك والمنصات التابعة لها موافقةً ضمنيةً من المستخدم على سياسة الخصوصية.
                </Paragraph>
                ...
                <Paragraph>
                  منصة دير عقارك غير مسئولة تحت أي ظرف من الظروف عن أي أضرار مباشرة أو غير مباشرة أو عرضية أو تبعية أو خاصة أو استثنائية تنشأ من استخدام أو عدم القدرة على استخدام المنصة.
                </Paragraph>

                <SectionHeader title="ما هي البيانات الشخصية التي نجمعها؟" icon={Server} />
                <Paragraph>تقوم منصة دير عقارك بجمع البيانات الشخصية من خلال المصادر التالية:</Paragraph>
                <List items={[
