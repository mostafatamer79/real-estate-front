                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 pt-4 border-t border-slate-100">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 rounded-2xl border-2 border-slate-900 bg-slate-50 flex items-center gap-3">
                                    <CreditCard className="w-6 h-6 text-slate-900" />
                                    <span className="font-bold text-slate-900">بطاقة صراف</span>
                                </div>
                                <div className="p-4 rounded-2xl border-2 border-slate-50 opacity-40 flex items-center gap-3">
