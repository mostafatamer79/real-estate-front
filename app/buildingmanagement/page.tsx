...
function BuildingManagementContent({ 
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-5 text-center">
            <Upload className="w-12 h-10 text-gray-400 mx-auto mb-4" />
              ...
              {activeReportsSubTab === 'roi' ? (
                  <div className="p-10 space-y-10">
                   ...
                   <div className="p-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <div className="p-5 px-4 md:px-10 border-b border flex justify-between items-center bg-muted/30">
                          <div>
                           ...
                           <table className="w-full text-start">
                               ...
                               <tbody className="divide-y divide-slate-50">
                                   {loadingMaintenance ? (
                                       ...
                                       <tr>
                                           <td colSpan={5} className="p-32 text-center">
                                               <div className="flex flex-col items-center gap-3 md:gap-6 opacity-20">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-2xl border border shadow-sm p-3 sm:p-6">
              ...
              {loading.stats || loading.disputes ? (
                ...
                <div className="text-center py-6 md:py-12 opacity-40">
                ...
                {srActiveTab === "create" ? (
                  <m.div key="sr-create" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="bg-card rounded-[1.25rem] border border shadow-xl overflow-hidden">
                    <form onSubmit={srHandleSubmit} className="p-5 space-y-8">
                      ...
                      <div className="flex justify-end pt-4">
                        <button disabled={srIsSubmitting} type="submit" className="bg-slate-950 text-white px-4 md:px-10 py-5 rounded-[1.25rem] font-black text-xs uppercase tracking-[0.2em] flex items-center gap-4 disabled:opacity-50 shadow-2xl shadow-stone-400/20 hover:bg-slate-800 transition-all active:scale-95">
                      ...
                      <div className="py-4">
                        <T defaultValue="details" className="w-full">
                          ...
                          <TC value="visits" className="space-y-4">
                            {srIsLoadingRelated ? (
                              <div className="py-6 md:py-12 flex justify-center"><Loader2 className="w-8 h-8 animate-spin text-slate-400" /></div>
                              ...
                              <div className="py-6 md:py-12 text-center text-slate-400 flex flex-col items-center gap-2"><Calendar className="w-8 h-8 opacity-50" /><p className="text-xs font-bold">{t('admin.service_requests.no_visits')}</p></div>
                            )}
                          </TC>
                          ...
                          <TC value="invoices" className="space-y-4">
                            {srIsLoadingRelated ? (
                              ...
                              <div className="py-6 md:py-12 text-center text-slate-400 flex flex-col items-center gap-2"><Receipt className="w-8 h-8 opacity-50" /><p className="text-xs font-bold">{t('admin.service_requests.no_invoices')}</p></div>
                            )}
                          </TC>
                        </T>
                      </div>
      ...
      <DialogContent className="w-[95vw] sm:max-w-[520px] max-h-[90vh] overflow-y-auto" dir={language === 'ar' ? 'rtl' : 'ltr'}>
        ...
        <form onSubmit={handleCreateMaintenanceLog} className="space-y-6 py-4">
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            <Button type="button" variant="outline" onClick={() => setShowNewMaintenanceModal(false)} className="rounded-xl h-10 px-6">
              {t('common.cancel')}
            </Button>
            <Button type="submit" className="bg-slate-600 hover:bg-slate-700 rounded-xl h-10 px-6">
              {t('common.save')}
            </Button>
          </DialogFooter>
        </form>
  ...
  const renderFinancial = () => (
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500" dir={language === 'ar' ? 'rtl' : 'ltr'}>
          ...
          <div className="bg-card rounded-[1rem] border border overflow-hidden shadow-2xl shadow-stone-400">
             {loadingFinancial ? (
                 <div className="p-32 text-center flex flex-col items-center gap-3 md:gap-6">
                    <div className="relative">
            ...
            <TabsContent value="new">
              <div className="bg-card rounded-2xl shadow-xl shadow-slate-50/50 border border p-5 mb-5 pb-20">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h1 className="text-xl font-bold text-gray-900">{t('bm.offer.new')}</h1>
                    <p className="text-xs text-gray-500 font-medium">{t('bm.offer.newSub')}</p>
                  </div>
                </div>
            ...
            <RadioGroup defaultValue="residential" className="grid grid-cols-1 md:grid-cols-2 gap-3" onValueChange={(val) => handleCategoryChange(val as "residential" | "commercial")}>
                ...
                >
                    ...
                    <div>
                        ...
                        <Label htmlFor="res" className="text-xs font-bold cursor-pointer block">{t('bm.offer.residential')}</Label>
                        <p className="text-[9px] text-gray-400 leading-tight">{t('bm.offer.basicDesc')}</p>
                    </div>
                </div>
                <div 
                ...
                >
                    ...
                    <div>
                        ...
                        <Label htmlFor="comm" className="text-xs font-bold cursor-pointer block">{t('bm.offer.commercial')}</Label>
                        <p className="text-[9px] text-gray-400 leading-tight">{t('bm.offer.basicDesc')}</p>
                    </div>
                </div>
            </RadioGroup>
        ...
        <form onSubmit={handleOfferSubmit} className="space-y-6">
          ...
          <div className="bg-muted/50 rounded-2xl p-5 border border">
            <div className="flex items-center gap-2 mb-4">
                ...
                <div>
                    <h3 className="text-sm font-bold text-gray-900">{t('bm.offer.media')}</h3>
                    <p className="text-[10px] text-gray-500">{t('bm.offer.mediaDesc')}</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 ...
                 >
                    ...
                    <p className="text-[10px] text-gray-400">{t('bm.offer.media.hint')}</p>
       ...
       <div className="space-y-4">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
                {loadingAllOffers ? (
                    ...
                    <div className="col-span-full text-center py-6 md:py-12 bg-muted rounded-xl">
            ...
            {activeSubscriptionTab === "new" ? (
              ...
              <div className="space-y-4">
                {subscriptions.length === 0 ? (
                  <div className="text-center py-6 md:py-12 bg-muted rounded-xl">
  ...
  return (
    <>
      ...
      <div className="internal-page-root flex h-screen overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100/90 text-slate-950 relative" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            ...
            <div className="py-4">
              <SegmentedTabs defaultValue="details" className="w-full" dir={language === 'ar' ? 'rtl' : 'ltr'}>
                <div className="flex justify-center w-full">
                  <SegmentedList className="grid w-full max-w-xs grid-cols-3 mb-6 bg-muted p-1 rounded-xl h-auto">
                    <SegmentedTrigger value="details" className="py-2 rounded-lg font-bold">{t("common.details")}</SegmentedTrigger>
                    <SegmentedTrigger value="visits" className="py-2 rounded-lg font-bold">{t("admin.service_requests.visits")}</SegmentedTrigger>
                    <SegmentedTrigger value="invoices" className="py-2 rounded-lg font-bold">{t("admin.service_requests.invoices")}</SegmentedTrigger>
                  </SegmentedList>
                </div>
                ...
                <TabsContent value="visits" className="space-y-4">
                  {srIsLoadingRelated ? (
                    <div className="py-6 md:py-12 flex justify-center"><Loader2 className="w-8 h-8 animate-spin text-slate-300" /></div>
                  ) : srUserBookings.length > 0 ? (
                    ...
                    <div className="py-6 md:py-12 text-center text-slate-400 flex flex-col items-center gap-2 opacity-40">
