...
export default function ServiceRequestsPage() {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 md:px-6 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 p-3 sm:p-6">
            {/* Header Section */}
                            ...
                            <Tabs defaultValue="details" className="w-full">
                                ...
                                <TabsContent value="visits" className="space-y-4">
                                    {isLoadingRelated ? (
                                        ...
                                        <div className="py-6 md:py-12 text-center text-slate-400 flex flex-col items-center gap-2">
