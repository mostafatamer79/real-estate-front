          ...
          <div className="w-full max-w-3xl max-h-[88vh] overflow-hidden rounded-[2rem] border border-white/10 bg-white text-slate-950 shadow-2xl" dir="rtl">
            ...
            <div className="border-t border-slate-100 bg-white px-6 py-5">
              <label className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm font-black text-slate-800">
                ...
                />
                <span>
                  أقر بأنني قرأت إخلاء المسؤولية وأوافق على البدء في مسح الحي. ويُعد استخدامي لخدمة مسح الحي بالذكاء الاصطناعي أو اعتمادي على هذا التقرير، إقراراً علنياً وصريحاً مني بالعلم التام بطبيعة الخدمات التقنية واحتمالية وجود نسبة خطأ أو تباين إحصائي في مخرجاتها.
                </span>
              </label>
