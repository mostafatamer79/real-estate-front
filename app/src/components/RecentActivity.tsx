        ...
        <div className="space-y-6" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            ...
            <div className="grid gap-4">
                {activities.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-12 px-6 bg-slate-900/20 border border-slate-800/40 rounded-[2.5rem] border-dashed">
                        <AlertCircle className="w-8 h-8 text-slate-700 mb-4" />
                        <p className="text-slate-500 text-sm font-medium">
                            {language === 'ar' ? 'لا توجد نشاطات حالياً' : 'No recent activities found'}
                        </p>
                    </div>
                )}
            </div>
