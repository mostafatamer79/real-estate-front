      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`fixed bottom-24 left-6 z-50 transition-all duration-300 ease-out md:bottom-24 max-md:bottom-[calc(88px+env(safe-area-inset-bottom))] max-md:left-4 max-md:right-4`}
            dir={language === 'ar' ? "rtl" : "ltr"}
          >
            <div className="bg-card rounded-2xl shadow-2xl w-96 h-[500px] flex flex-col border border overflow-hidden max-md:w-auto max-md:h-[70vh]">
              {/* Header */}
              <div className="flex items-center justify-between px-4 py-3 bg-slate-700 text-white">
                ...
                <div className="flex items-center gap-2">
                   ...
                   <button onClick={() => { handleCreateBooking(); hapticTick(); }} title="Simulate Payment Request" className="text-white hover:text-green-300 transition-colors">
              ...
              >
                {messages.map((message, index) => (
                  ...
                  >
                    <div
                      className={`max-w-[85%] rounded-lg p-3 shadow-sm transition-all duration-200 ${
                        message.sender === "user"
                          ? "bg-[#DCF8C6] text-gray-900 rounded-tr-none"
                          : "bg-card text-gray-900 rounded-tl-none border border-gray-100"
                      }`}
                    >
                          ...
                          <div className="space-y-2">
                           ...
                           <div className="space-y-2">
                              ...
                              <Button 
                                ...
                                onClick={() => { openPayment(message.metadata?.bookingId!, message.metadata?.price!); hapticTick(); }}
                              >
                                {t('chat.payNow')}
                            </Button>
                          </div>
              ...
              <div className="p-2 bg-[#f0f2f5] border-t border">
                <div className="flex gap-2 items-end">
                  <div className="flex-1 bg-card rounded-full px-4 py-2 border border-gray-300 focus-within:border-[#075E54] focus-within:shadow-lg focus-within:shadow-[#075E54]/5 transition-all">
                    <Input
                      value={inputValue}
