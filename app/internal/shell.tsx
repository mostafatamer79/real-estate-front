  ...
  return (
    <div className="flex h-screen bg-muted overflow-hidden" dir={isRtl ? "rtl" : "ltr"}>
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Slim top bar */}
        <div className="h-16 bg-card border-b border flex items-center justify-between px-4 md:px-8 gap-3 shrink-0">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className={isChat ? "h-full flex flex-col" : `${currentView === "dashboard" || isHub ? "max-w-5xl" : "max-w-[1400px]"} mx-auto py-4 md:py-8 px-4 md:px-6 lg:px-8`}>
            {children}
          </div>
        </div>
      </main>
