...
//           <h2 className="text-3xl font-black leading-tight text-white sm:text-3xl sm:text-5xl">كل إدارة تتحرك في نفس النظام، لكن لكل واحدة مسارها الخاص.</h2>
    ...
    <main className="min-h-screen overflow-x-hidden bg-slate-950 text-white" dir={isRtl ? "rtl" : "ltr"}>
      ...
      <section className="relative mx-auto max-w-7xl px-5 py-24 sm:px-8 lg:px-12">
        <div className="mb-12 max-w-4xl space-y-4">
          <h2 className="text-3xl font-black leading-[1.35] text-white sm:text-3xl sm:text-5xl">كل جزء في المنصة يخدم قراراً أو إجراءً داخل الرحلة العقارية.</h2>
      ...
      {/* <section className="relative border-y border-white/10 bg-slate-950 px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="space-y-5">
            ...
            <h2 className="text-3xl font-black leading-tight text-white sm:text-3xl sm:text-5xl">من أول نقرة حتى إغلاق العملية.</h2>
            <p className="text-base font-bold leading-8 text-white/65">
      ...
      {/* <section className="relative mx-auto max-w-7xl px-5 py-24 sm:px-8 lg:px-12">
        <div className="mb-12 w-[95vw] sm:max-w-3xl space-y-4">
          ...
          <h2 className="text-3xl font-black leading-tight text-white sm:text-3xl sm:text-5xl">الإدارة ترى الصورة كاملة.</h2>
          <p className="text-base font-bold leading-8 text-white/65">
      ...
      <section className="relative px-5 pb-28 sm:px-8 lg:px-12">
        ...
        >
          ...
          <h2 className="relative z-10 mx-auto mt-6 max-w-4xl text-3xl font-black leading-tight text-white sm:text-3xl sm:text-5xl">هدفنا أن تكون كل خطوة عقارية قابلة للفهم، المتابعة، والتوثيق.</h2>
