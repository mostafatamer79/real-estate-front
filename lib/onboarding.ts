  ...
  return [
    {
      ...
      targetId: "tour-target-customer-service",
      mobileTargetId: "tour-target-mobile-menu",
      position: "bottom",
    ...
    },
    {
      ...
      targetId: "tour-target-subscriptions",
      position: "top",
      icon: tourIcon(Grid),
    },
    {
